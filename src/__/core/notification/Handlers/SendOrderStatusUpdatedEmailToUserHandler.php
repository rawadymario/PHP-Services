<?php
	...
	class SendOrderStatusUpdatedEmailToUserHandler {
		...
		public static function Send(array $payload=[], ?array $mainPayload=[]) {
			...
			$handler->notificationManager->SetTemplate("order/SendOrderStatusUpdatedEmailToUser");
			
			$handler->notificationManager->SetQueueName("SendOrderStatusUpdatedEmailToUser");
